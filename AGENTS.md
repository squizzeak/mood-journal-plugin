...
This is a distributable skill plugin, not a live journal. Use fictional data only. Do not read or copy health records from the surrounding machine/project. Do not modify installed skills or local plugin registries while working here.

Keep the portable and compatibility manifest name/version/description synchronized. Preserve the CC BY-SA attribution and the capability-based storage design. Do not add mandatory service dependencies, hard-coded identities, timezones, or private paths.
